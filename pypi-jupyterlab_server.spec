...
Source0  : https://files.pythonhosted.org/packages/43/fb/27a62802a8eb3baa4a00ec208dfd7355a472b5b20bc42aea40f4610e143a/jupyterlab_server-2.26.0.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.26.0
cd %{_builddir}/jupyterlab_server-2.26.0
pushd ..
cp -a jupyterlab_server-2.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712587575
