...
Source0  : https://files.pythonhosted.org/packages/17/3b/9fbc041222daeb5d518b5e5e285a07cb1acc2fa9c94ebb393d249d2ea046/jupyterlab_server-2.15.2.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.15.2
cd %{_builddir}/jupyterlab_server-2.15.2
pushd ..
cp -a jupyterlab_server-2.15.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664231358
