...
Version  : 2.16.6
Release  : 94
URL      : https://files.pythonhosted.org/packages/9d/a4/beb1d925eb2c313efdc600b2e826eeb921928fc646784e6c696a3d38044c/jupyterlab_server-2.16.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/9d/a4/beb1d925eb2c313efdc600b2e826eeb921928fc646784e6c696a3d38044c/jupyterlab_server-2.16.6.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.16.6
cd %{_builddir}/jupyterlab_server-2.16.6
pushd ..
cp -a jupyterlab_server-2.16.6 buildavx2
cp -a jupyterlab_server-2.16.6 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671818476
