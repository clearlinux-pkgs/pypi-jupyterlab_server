...
Source0  : https://files.pythonhosted.org/packages/bb/d3/a2e98458e1e1d2af2dd6e9204b8be3b93225ab2a644770869f16dfcb3e6d/jupyterlab_server-2.19.0.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.19.0
cd %{_builddir}/jupyterlab_server-2.19.0
pushd ..
cp -a jupyterlab_server-2.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673891318
