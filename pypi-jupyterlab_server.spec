...
Source0  : https://files.pythonhosted.org/packages/f9/f5/dc3d3075e54872088c968c12944492118d9f87c7ecb713ed478119a82e7a/jupyterlab_server-2.16.3.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.16.3
cd %{_builddir}/jupyterlab_server-2.16.3
pushd ..
cp -a jupyterlab_server-2.16.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668448051
