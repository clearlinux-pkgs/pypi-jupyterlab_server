...
Source0  : https://files.pythonhosted.org/packages/c9/12/19935f704a8b2e45d1ce8dfd1253e5651ce16d0fe7865516261eb451dcd0/jupyterlab_server-2.15.1.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.15.1
cd %{_builddir}/jupyterlab_server-2.15.1
pushd ..
cp -a jupyterlab_server-2.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661354387
