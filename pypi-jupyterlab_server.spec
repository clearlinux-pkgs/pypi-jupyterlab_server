...
Source0  : https://files.pythonhosted.org/packages/36/ac/81c0b5f2ddad5e41e1a76ea88d401064a348b27a85b1a0b947c1776943ca/jupyterlab_server-2.13.0.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.13.0
cd %{_builddir}/jupyterlab_server-2.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650413979
...
cp %{_builddir}/jupyterlab_server-2.13.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
